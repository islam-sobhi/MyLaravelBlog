...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/dataTables.bootstrap.min.css">
	    <link href="../online/css/mystyle.css" rel="stylesheet">

	<link href="assets/css/bootstrap.css" rel="stylesheet" />
  <link href="../online/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" />
<link href="../online/vendor/font-awesome/css/font-awesome.css/font-awesome.css" rel="stylesheet" />
  ...
  <body  >
	...
	<div class="container">
<marquee><p dir="rtl" lang="ar" class="center" style="color: #dbceab;font-size: 27px; text-align: center; border: cornflowerblue;  border-bottom-style: double;">رَبٍّ زِدْنٍي عِلمًا</p></marquee>
      ...
      {
      ?>
	  <img src="img/10.jpg" style="width: 100Px; height: 100px;border-radius: 100%;" />
      <h3 align="center" style="margin-top: -63px;">Invoice System </h3>

      <br />
      <div align="right">
        <a href="create.php?add=1" class="btn btn-info btn-xs">Create</a>
      </div>
      <br />
          ...
          foreach($all_result as $row)
          {
            echo '
              <tr>
                ...
                <td><a href="invoice.php?update=1&id='.$row["order_id"].'"class="btn btn-primary"><span class="fa fa-edit "> Edit</span></a></td>
                <td><a href="#" id="'.$row["order_id"].'" class="delete"><button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button></a></td>
              </tr>
            ';
          }
        }
...
<script>
 ...
 <div align="center">
        <a href="backup2.php" class="btn btn-info btn-xs">Create</a>
    </div>
